...
public class TestDataBuilder {
    ...
    public static Customer createCustomer(Long customerId, String companyName, String street, String houseNr,
	    String city, String postCode, String firstName, String lastName) {
